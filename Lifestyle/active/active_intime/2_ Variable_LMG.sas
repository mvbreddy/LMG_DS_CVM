...
proc sql;
create table SPDTMP7.VB_ALL_TN_ITM_REV_AE_overall (compress=yes) as
...
from SPDTMP7.VB_ALL_TN_ITM_REV_AE
 
group by LMG_MEM_CARD_Number;

quit;

data SPDTMP7.VB_ALL_TN_ITM_REV_AE_overall_1(compress=yes);
set SPDTMP7.VB_ALL_TN_ITM_REV_AE_overall;
...
/*proc means data= SPDTMP7.VB_ALL_TN_ITM_REV_AE_overall_1;*/
/*run;*/
...
data SPDTMP7.VB_ALL_TN_ITM_REV_AE9(compress=yes);
set SPDTMP7.VB_ALL_TN_ITM_REV_AE (keep= lmg_mem_card_number lmg_concept_name txn_dt_wid revenue_aed invoice_number units item_code base_points_accrued date);
where txn_dt_wid>=20160501 and txn_dt_wid<=20170131 ;

run;

proc sql;
create table SPDTMP7.VB_ALL_TN_ITM_REV_AE9_2 (compress=yes) as
select LMG_MEM_CARD_Number, 
...
from SPDTMP7.VB_ALL_TN_ITM_REV_AE9
...
data SPDTMP7.VB_ALL_TN_ITM_REV_AE9_3(compress=yes);
set SPDTMP7.VB_ALL_TN_ITM_REV_AE9_2;
...
/*proc means data= SPDTMP7.VB_ALL_TN_ITM_REV_AE9_3;*/
/*run;*/


data SPDTMP7.VB_ALL_TN_ITM_REV_AE6(compress=yes);
set SPDTMP7.VB_ALL_TN_ITM_REV_AE(keep= lmg_mem_card_number lmg_concept_name  txn_dt_wid revenue_aed invoice_number units item_code base_points_accrued date);
where txn_dt_wid>=20160801 and txn_dt_wid<=20170131 ;

run;


proc sql;
create table SPDTMP7.VB_ALL_TN_ITM_REV_AE6_2 (compress=yes) as
select LMG_MEM_CARD_Number, 
...
from SPDTMP7.VB_ALL_TN_ITM_REV_AE6
group by LMG_MEM_CARD_Number;
quit;

data SPDTMP7.VB_ALL_TN_ITM_REV_AE6_3(compress=yes);
set SPDTMP7.VB_ALL_TN_ITM_REV_AE6_2;
...
/*proc means data= SPDTMP7.VB_ALL_TN_ITM_REV_AE6_3;*/
/*run;*/


data SPDTMP7.VB_ALL_TN_ITM_REV_AE3(compress=yes);
set SPDTMP7.VB_ALL_TN_ITM_REV_AE(keep= lmg_mem_card_number lmg_concept_name txn_dt_wid revenue_aed invoice_number units item_code base_points_accrued date);
where txn_dt_wid>=20161101 and txn_dt_wid<=20170131 ;
run;

proc sql;
create table SPDTMP7.VB_ALL_TN_ITM_REV_AE3_2 (compress=yes) as
select LMG_MEM_CARD_Number, 
...
from SPDTMP7.VB_ALL_TN_ITM_REV_AE3
group by LMG_MEM_CARD_Number;
quit;

data SPDTMP7.VB_ALL_TN_ITM_REV_AE3_3(compress=yes);
set SPDTMP7.VB_ALL_TN_ITM_REV_AE3_2;
...
proc sql;
create Table SPDTMP7.VB_ALL_TN_ITM_REV_AE_1_newer (compress=yes, drop = end_date_lmg start_date_lmg end_date_lmg9 start_date_lmg9 end_date_lmg6 start_date_lmg6 end_date_lmg3 start_date_lmg3) as 
select * from SPDTMP7.VB_ALL_TN_ITM_REV_AE_overall_1 as T1
left join (Select * from (select * from SPDTMP7.VB_ALL_TN_ITM_REV_AE9_3 as a 
				              left join SPDTMP7.VB_ALL_TN_ITM_REV_AE6_3 as b 
				               on a.LMG_MEM_CARD_NUMBER = b.LMG_MEM_CARD_NUMBER) as c
                          left join SPDTMP7.VB_ALL_TN_ITM_REV_AE3_3 as d
