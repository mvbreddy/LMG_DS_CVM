...
proc sql;
create table SPDTMP7.VB_LS_SHHB_TN_ITM_REV_AE_1_1 (Compress = yes) as 
    select * from SPDTMP7.VB_LS_TN_ITM_REV_AE_1_1 as ls
	          left join (select * from SPDTMP7.VB_SH_TN_ITM_REV_AE_1_1 as sh
								 left join  (select * from SPDTMP7.VB_HC_TN_ITM_REV_AE_1_1 as hc
			  							                    left join (select * from SPDTMP7.VB_HB_TN_ITM_REV_AE_1_1 as hb
													 					left join SPDTMP7.VB_BS_TN_ITM_REV_AE_1_1 as bs
...
proc sql;
Create Table SPDTMP7.VB_ALL_LS_LMG_TN_ITM_REV_AE (compress=yes) as 
select * from SPDTMP7.VB_LS_SHHB_TN_ITM_REV_AE_1_1 as a
left join SPDTMP7.VB_ALL_TN_ITM_REV_AE_1_newer as b
on a.LMG_MEM_CARD_NUMBER  = b.LMG_MEM_CARD_NUMBER;
Quit;


/* proc contents data=SPDTMP7.VB_ALL_LS_LMG_TN_ITM_REV_AE;
run;   */

/*Creating a dataset of final Variables from VB_ALL_CUST_DETL_LMG_AE Customer Details Table*/
data SPDTMP7.VB_LS_CUST_DETL_LMG_AE_1  (compress = yes);
set SPDTMP7.VB_LS_CUST_DETL_LMG_AE (Keep= LMG_MEM_CARD_NUMBER SEX_MF_NAME  
		 LANG_NAME  AGE LMG_EFFECTIVE_POINTS CVM_Nationality_group ); 

run;

/* proc freq data= SPDTMP7.VB_LS_CUST_DETL_LMG_AE ; */
...
proc sql;
Create Table SPDTMP7.VB_CUS_TN_ITM_REV_AE (compress=yes) as 
select * from SPDTMP7.VB_ALL_LS_LMG_TN_ITM_REV_AE as a
left join SPDTMP7.VB_LS_CUST_DETL_LMG_AE_1 as b
on a.LMG_MEM_CARD_NUMBER  = b.LMG_MEM_CARD_NUMBER;
Quit;
...
proc sql;
create table SPDTMP7.VB_CUS_TN_ITM_REV_AE_0 (compress = yes) as
select * from SPDTMP7.VB_CUS_TN_ITM_REV_AE as a 
