...
proc sql ;
  Create Table SPDTMP7.VB_SH_TN_ITM_REV_AE_1 (compress = yes) as
   select LMG_MEM_CARD_NUMBER 
		...
		from SPDTMP7.VB_SH_TN_ITM_REV_AE_
Group By LMG_MEM_CARD_NUMBER ;
quit;

data SPDTMP7.VB_SH_TN_ITM_REV_AE_1_1(compress = yes);
set SPDTMP7.VB_SH_TN_ITM_REV_AE_1;
