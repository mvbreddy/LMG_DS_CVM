...
/*creating a predicted or dependent variable */

data SPDTMP30.VB_LS_TN_ITM_REV_AE_Model (Compress=yes);
      set sascrm.TN_ITM_REV_AE ;
  	   where TXN_DT_WID >= 20160301 and TXN_DT_WID<= 20160331 and LMG_CONCEPT_NAME = "Lifestyle" and TRANSACTION_TYPE = "Purchase" and units >= 0 and revenue_aed >= 0 and Retail_cost_1_AED >= 0 and Retail_cost_2_AED>= 0 ;
	   Bought_flag = 1;
run;

proc sql ;
create table SPDTMP30.VB_LS_TN_ITM_REV_AE_Cust (compress=yes) as
select Distinct LMG_MEM_CARD_NUMBER, Bought_flag from SPDTMP30.VB_LS_TN_ITM_REV_AE_Model ;
quit;

proc sql;
create table SPDTMP30.VB_CUS_TN_ITM_REV_AE_3 (Compress = yes) as 
select *
from SPDTMP30.VB_CUS_TN_ITM_REV_AE_2 as a
left join SPDTMP30.VB_LS_TN_ITM_REV_AE_Cust as b
on a.LMG_MEM_CARD_NUMBER = b.LMG_MEM_CARD_NUMBER;
quit; 

Data SPDTMP30.VB_CUS_TN_ITM_REV_AE_3new;
set SPDTMP30.VB_CUS_TN_ITM_REV_AE_3;
...
proc stdize data=SPDTMP30.VB_CUS_TN_ITM_REV_AE_3new OUT=SPDTMP30.VB_CUS_TN_ITM_REV_AE_4  reponly missing=0;
...
data SPDTMP30.VB_CUS_TN_ITM_REV_AE_5;
set SPDTMP30.VB_CUS_TN_ITM_REV_AE_4;
		/* Age Dummy */
...
run;
 ...
 proc freq data= SPDTMP30.VB_CUS_TN_ITM_REV_AE_5;
 tables Lstage_Sgmnt;
 run;

data SPDTMP30.VB_CUS_TN_ITM_REV_AE_6;
set SPDTMP30.VB_CUS_TN_ITM_REV_AE_5;
where Lstage_Sgmnt <> "" ;
run;
