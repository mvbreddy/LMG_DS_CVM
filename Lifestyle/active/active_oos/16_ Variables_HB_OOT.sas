...
proc sql ;
  Create Table SPDTMP30.VB_HB_TN_ITM_REV_AE_1 (compress = yes) as
...
from SPDTMP30.VB_HB_TN_ITM_REV_AE_
Group By LMG_MEM_CARD_NUMBER ;
quit;

data SPDTMP30.VB_HB_TN_ITM_REV_AE_1_1(compress = yes);
set SPDTMP30.VB_HB_TN_ITM_REV_AE_1;
