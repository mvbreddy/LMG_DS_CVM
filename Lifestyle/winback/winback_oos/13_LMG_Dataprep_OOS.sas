...
data spdtmp7.VB_WB_OOS_LMG_ALL_TXN(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_OOS_LS_TXN;
where txn_dt_wid >= 20140201 and txn_dt_wid <=20150131 and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
/*all metrics LMG all customers*/


proc sql;
create table spdtmp7.VB_WB_OOS_LMG_ALL_TXN (compress=yes) as
...
from spdtmp7.VB_WB_OOS_LMG_ALL_TXN
group by LMG_MEM_CARD_Number;
quit;

data spdtmp7.VB_WB_OOS_LMG_ALL_TXN(compress=yes);
set spdtmp7.VB_WB_OOS_LMG_ALL_TXN;
format start_date_lmg ddmmyys10.;
format end_date_lmg ddmmyys10.;
recency_lmg=intck('day',end_date_lmg,'31Jan2015'd);
...
data spdtmp7.VB_WB_OOS_LMG_3_TXN(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_OOS_LS_TXN;
where txn_Dt_wid>=20141101 and txn_dt_wid<=20150131 and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.VB_WB_OOS_LMG_3_TXN(compress=yes) as
select  LMG_mem_card_number, 
...
from spdtmp7.VB_WB_OOS_LMG_3_TXN
...
data spdtmp7.VB_WB_OOS_LMG_3_TXN(compress=yes);
set spdtmp7.VB_WB_OOS_LMG_3_TXN;
format start_date_lmg3 ddmmyys10.;
format end_date_lmg3 ddmmyys10.;
recency_lmg3=intck('day',end_date_lmg3,'31Jan2015'd);
...
data spdtmp7.VB_WB_OOS_LMG_6_TXN(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_OOS_LS_TXN;
where txn_Dt_wid>=20140801 and txn_dt_wid<=20150131 and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.VB_WB_OOS_LMG_6_TXN(compress=yes) as
...
from spdtmp7.VB_WB_OOS_LMG_6_TXN
...
data spdtmp7.VB_WB_OOS_LMG_6_TXN(compress=yes);
set spdtmp7.VB_WB_OOS_LMG_6_TXN;
format start_date_lmg6 ddmmyys10.;
format end_date_lmg6 ddmmyys10.;
recency_lmg6=intck('day',end_date_lmg6,'31Jan2015'd);
...
data spdtmp7.VB_WB_OOS_LMG_9_TXN(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_OOS_LS_TXN;
where txn_Dt_wid>=20140501 and txn_dt_wid<=20150131 and  revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;

proc sql;
create table spdtmp7.VB_WB_OOS_LMG_9_TXN(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.VB_WB_OOS_LMG_9_TXN
...
data spdtmp7.VB_WB_OOS_LMG_9_TXN(compress=yes);
set spdtmp7.VB_WB_OOS_LMG_9_TXN;
format start_date_lmg9 ddmmyys10.;
format end_date_lmg9 ddmmyys10.;
recency_lmg9=intck('day',end_date_lmg9,'31Jan2015'd);
...
proc sql; 
create table spdtmp7.VB_WB_OOS_LMG_TXN_Overall (compress=yes) as
select a.*,b.*,c.*,d.* from spdtmp7.VB_WB_OOS_LMG_ALL_TXN a 
left join  spdtmp7.VB_WB_OOS_LMG_3_TXN b on a.Lmg_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.VB_WB_OOS_LMG_6_TXN c on a.LMG_mem_card_number=c.LMG_mem_card_number
left join spdtmp7.VB_WB_OOS_LMG_9_TXN d on a.LMG_mem_card_number=d.LMG_mem_card_number;
quit;



proc delete data=spdtmp7.VB_WB_OOS_LMG_3_TXN;
proc delete data=spdtmp7.VB_WB_OOS_LMG_6_TXN;
proc delete data=spdtmp7.VB_WB_OOS_LMG_9_TXN;