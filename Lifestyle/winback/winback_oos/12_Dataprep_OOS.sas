...
proc sql;
create table spdtmp7.VB_WB_OOS_LS_TXN_Cust2014 (compress=yes) as 
select distinct LMG_mem_Card_number from spdtmp7.sd_txn_wb
where Lmg_concept_name="Lifestyle" and txn_dt_wid<=20150131 and txn_dt_wid >= 20140201
...
/*select count(distinct LMG_mem_Card_number) from spdtmp7.sd_txn_custhc2015;*/
/*quit;*/
...
proc sql;
create table spdtmp7.VB_WB_OOS_LS_TXN_Cust2015 (compress=yes) as 
select distinct LMG_mem_Card_number from spdtmp7.sd_txn_wb
where Lmg_concept_name="Lifestyle" and txn_dt_wid>=20150201 and  txn_dt_wid<=20160131
group by LMG_mem_card_number;
quit;
...
data spdtmp7.VB_WB_OOS_LS_Cust(compress=yes);
merge spdtmp7.VB_WB_OOS_LS_TXN_Cust2014(in=a) spdtmp7.VB_WB_OOS_LS_TXN_Cust2015(in=b);
if a=1 and b=0 ;
...
/*proc delete data=spdtmp7.VB_WB_OOS_LS_TXN_Cust2014;run;*/
/**/
/*proc delete data=spdtmp7.VB_WB_OOS_LS_TXN_Cust2015;run;*/

/*Table for wb cust base all obs*/

proc sql;
create table spdtmp7.VB_WB_OOS_LS_TXN(compress=yes) as
select a.*,b.* from spdtmp7.VB_WB_OOS_LS_Cust a 
left join spdtmp7.sd_txn_wb b
on a.LMG_mem_Card_number=b.LMG_mem_card_number
where 20140201 <= b.txn_dt_wid <= 20150131;
quit;

/*Lifestyle winback customers*/

data spdtmp7.VB_WB_OOS_LS_ALL_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_OOS_LS_TXN;
where txn_dt_wid<=20150131 and txn_dt_wid>=20140201 and LMG_concept_name="Lifestyle" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.VB_WB_OOS_LS_ALL_TXN (compress=yes) as
...
from spdtmp7.VB_WB_OOS_LS_ALL_TXN
group by LMG_MEM_CARD_Number;
quit;

data spdtmp7.VB_WB_OOS_LS_ALL_TXN(compress=yes);
set spdtmp7.VB_WB_OOS_LS_ALL_TXN;
format start_date ddmmyys10.;
format end_date ddmmyys10.;
recency=intck('day',end_date,'31Jan2015'd);
...
data spdtmp7.VB_WB_OOS_LS_3_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_OOS_LS_TXN;
where txn_Dt_wid>=20141101 and txn_dt_wid<=20150131 and LMG_concept_name="Lifestyle" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.VB_WB_OOS_LS_3_TXN(compress=yes) as
select  LMG_mem_card_number, 
...
from spdtmp7.VB_WB_OOS_LS_3_TXN
...
data spdtmp7.VB_WB_OOS_LS_3_TXN(compress=yes);
set spdtmp7.VB_WB_OOS_LS_3_TXN;
format start_date_3 ddmmyys10.;
format end_date_3 ddmmyys10.;
recency_3=intck('day',end_date_3,'31Jan2015'd);
...
data spdtmp7.VB_WB_OOS_LS_6_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_OOS_LS_TXN;
where txn_Dt_wid>=20140801 and txn_dt_wid<=20150131 and LMG_concept_name="Lifestyle" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.VB_WB_OOS_LS_6_TXN(compress=yes) as
...
from spdtmp7.VB_WB_OOS_LS_6_TXN
...
data spdtmp7.VB_WB_OOS_LS_6_TXN(compress=yes);
set spdtmp7.VB_WB_OOS_LS_6_TXN;
format start_date_6 ddmmyys10.;
format end_date_6 ddmmyys10.;
recency_6=intck('day',end_date_6,'31Jan2015'd);
...
data spdtmp7.VB_WB_OOS_LS_9_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_OOS_LS_TXN;
where txn_Dt_wid>=20140501 and txn_dt_wid<=20150131 and LMG_concept_name="Lifestyle" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;

proc sql;
create table spdtmp7.VB_WB_OOS_LS_9_TXN(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.VB_WB_OOS_LS_9_TXN
...
data spdtmp7.VB_WB_OOS_LS_9_TXN(compress=yes);
set spdtmp7.VB_WB_OOS_LS_9_TXN;
format start_date_9 ddmmyys10.;
format end_date_9 ddmmyys10.;
recency_9=intck('day',end_date_9,'31Jan2015'd);
...
proc sql; 
create table spdtmp7.VB_WB_OOS_LS_TXN_Overall (compress=yes) as
select a.*,b.*,c.*,d.* from spdtmp7.VB_WB_OOS_LS_ALL_TXN a 
left join  spdtmp7.VB_WB_OOS_LS_3_TXN b on a.Lmg_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.VB_WB_OOS_LS_6_TXN c on a.LMG_mem_card_number=c.LMG_mem_card_number
left join spdtmp7.VB_WB_OOS_LS_9_TXN d on a.LMG_mem_card_number=d.LMG_mem_card_number;
quit;



proc delete data=spdtmp7.VB_WB_OOS_LS_3_TXN;
proc delete data=spdtmp7.VB_WB_OOS_LS_6_TXN;
proc delete data=spdtmp7.VB_WB_OOS_LS_9_TXN;




data spdtmp7.VB_WB_OOS_LS_TXN_1(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb;
where txn_dt_wid<=20141231 and LMG_concept_name="Lifestyle" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc freq data= spdtmp7.VB_WB_OOS_LS_TXN_1;
tables lmg_x_dept_cd;
run;

data spdtmp7.VB_WB_OOS_LS_TXN_2(compress=yes);
length dept $ 20;
set spdtmp7.VB_WB_OOS_LS_TXN_1;
...
proc sql;
create table spdtmp7.VB_WB_OOS_LS_TXN_3(compress=yes) as
select LMG_mem_card_number,
...
from spdtmp7.VB_WB_OOS_LS_TXN_2
group by LMG_mem_card_number;
quit;
...
proc sql;
create table spdtmp7.VB_WB_OOS_LS_TXN_4(compress=yes) as 
select LMG_mem_card_number,
...
proc sql;
create table spdtmp7.VB_WB_OOS_LS_TXN_5(compress=yes) as
select a.*,b.*,c.* from spdtmp7.VB_WB_OOS_LS_TXN_Overall a 
left join  spdtmp7.VB_WB_OOS_LS_TXN_3 b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join  spdtmp7.VB_WB_OOS_LS_TXN_4 c on a.LMG_mem_card_number=c.LMG_mem_card_number
;
quit; 
...
proc means data=spdtmp7.VB_WB_OOS_LS_TXN_5;
run;


proc delete data=spdtmp7.VB_WB_OOS_LS_TXN;run;
proc delete data=spdtmp7.VB_WB_OOS_LS_TXN_1;run;
