...
Data spdtmp7.VB_WB_Apr_LS_Alldata13 (compress=yes);
set spdtmp7.VB_WB_Apr_LS_Alldata12;
...
proc stdize data=spdtmp7.VB_WB_Apr_LS_Alldata13 OUT=spdtmp7.VB_WB_Apr_LS_Alldata14 (compress=yes)  reponly missing=0;
...
proc delete data= spdtmp7.VB_WB_Apr_LS_Alldata12; run;
proc delete data= spdtmp7.VB_WB_Apr_LS_Alldata11; run;
proc delete data= spdtmp7.VB_WB_Apr_LS_Alldata10; run;