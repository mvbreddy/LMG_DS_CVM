...
data spdtmp7.VB_AQ_OOS_LS_BS_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_AQ_OOS_LS_TXN;
where txn_dt_wid<=20160131 and txn_dt_wid >= 20150201 and LMG_concept_name="Babyshop" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.VB_AQ_OOS_LS_BS_TXN (compress=yes) as
...
from spdtmp7.VB_AQ_OOS_LS_BS_TXN
group by LMG_MEM_CARD_Number;
quit;

data spdtmp7.VB_AQ_OOS_LS_BS_TXN(compress=yes);
set spdtmp7.VB_AQ_OOS_LS_BS_TXN;
...
data spdtmp7.VB_AQ_OOS_LS_BS3_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_AQ_OOS_LS_TXN;
...
proc sql;
create table spdtmp7.VB_AQ_OOS_LS_BS3_TXN(compress=yes) as
select  LMG_mem_card_number, 
...
from spdtmp7.VB_AQ_OOS_LS_BS3_TXN
...
data spdtmp7.VB_AQ_OOS_LS_BS3_TXN(compress=yes);
set spdtmp7.VB_AQ_OOS_LS_BS3_TXN;
...
data spdtmp7.VB_AQ_OOS_LS_BS6_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_AQ_OOS_LS_TXN;
...
proc sql;
create table spdtmp7.VB_AQ_OOS_LS_BS6_TXN(compress=yes) as
...
from spdtmp7.VB_AQ_OOS_LS_BS6_TXN
...
data spdtmp7.VB_AQ_OOS_LS_BS6_TXN(compress=yes);
set spdtmp7.VB_AQ_OOS_LS_BS6_TXN;
...
data spdtmp7.VB_AQ_OOS_LS_BS9_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_AQ_OOS_LS_TXN;
...
proc sql;
create table spdtmp7.VB_AQ_OOS_LS_BS9_TXN(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.VB_AQ_OOS_LS_BS9_TXN
...
data spdtmp7.VB_AQ_OOS_LS_BS9_TXN(compress=yes);
set spdtmp7.VB_AQ_OOS_LS_BS9_TXN;
...
proc sql; 
create table spdtmp7.VB_AQ_OOS_LS_BS_TXN_Overall (compress=yes) as
select a.*,b.*,c.*,d.* from spdtmp7.VB_AQ_OOS_LS_BS_TXN a 
left join  spdtmp7.VB_AQ_OOS_LS_BS3_TXN b on a.Lmg_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.VB_AQ_OOS_LS_BS6_TXN c on a.LMG_mem_card_number=c.LMG_mem_card_number
left join spdtmp7.VB_AQ_OOS_LS_BS9_TXN d on a.LMG_mem_card_number=d.LMG_mem_card_number;
quit;



proc delete data=spdtmp7.VB_AQ_OOS_LS_BS3_TXN;
proc delete data=spdtmp7.VB_AQ_OOS_LS_BS6_TXN;
proc delete data=spdtmp7.VB_AQ_OOS_LS_BS9_TXN;
