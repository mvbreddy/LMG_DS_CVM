...
data spdtmp7.VB_AQ_LS_HC_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_AQ_LS_TXN;
where txn_dt_wid<=20170131 and txn_dt_wid >= 20160201 and LMG_concept_name="Home center" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.VB_AQ_LS_HC_TXN (compress=yes) as
...
from spdtmp7.VB_AQ_LS_HC_TXN
group by LMG_MEM_CARD_Number;
quit;

data spdtmp7.VB_AQ_LS_HC_TXN(compress=yes);
set spdtmp7.VB_AQ_LS_HC_TXN;
format start_date_HC ddmmyys10.;
format end_date_HC ddmmyys10.;
recency_HC=intck('day',end_date_HC,'31Jan2017'd);
...
data spdtmp7.VB_AQ_LS_HC3_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_AQ_LS_TXN;
where txn_Dt_wid>=20161101 and txn_dt_wid<=20170131 and LMG_concept_name="Home center" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.VB_AQ_LS_HC3_TXN(compress=yes) as
select  LMG_mem_card_number, 
...
data spdtmp7.VB_AQ_LS_HC3_TXN(compress=yes);
set spdtmp7.VB_AQ_LS_HC3_TXN;
format start_date_HC3 ddmmyys10.;
format end_date_HC3 ddmmyys10.;
recency_HC3=intck('day',end_date_HC3,'31Jan2017'd);
...
data spdtmp7.VB_AQ_LS_HC6_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_AQ_LS_TXN;
where txn_Dt_wid>=20160801 and txn_dt_wid<=20170131 and LMG_concept_name="Home center" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.VB_AQ_LS_HC6_TXN(compress=yes) as
...
data spdtmp7.VB_AQ_LS_HC6_TXN(compress=yes);
set spdtmp7.VB_AQ_LS_HC6_TXN;
format start_date_HC6 ddmmyys10.;
format end_date_HC6 ddmmyys10.;
recency_HC6=intck('day',end_date_HC6,'31Jan2017'd);
...
data spdtmp7.VB_AQ_LS_HC9_TXN(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_AQ_LS_TXN;
where txn_Dt_wid>=20160501 and txn_dt_wid<=20170131 and LMG_concept_name="Home center" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;

proc sql;
create table spdtmp7.VB_AQ_LS_HC9_TXN(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.VB_AQ_LS_HC9_TXN(compress=yes);
set spdtmp7.VB_AQ_LS_HC9_TXN;
format start_date_HC9 ddmmyys10.;
format end_date_HC9 ddmmyys10.;
recency_HC9=intck('day',end_date_HC9,'31Jan2017'd);
...
proc sql; 
create table spdtmp7.VB_AQ_LS_HC_TXN_Overall (compress=yes) as
select a.*,b.*,c.*,d.* from spdtmp7.VB_AQ_LS_HC_TXN a 
left join  spdtmp7.VB_AQ_LS_HC3_TXN b on a.Lmg_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.VB_AQ_LS_HC6_TXN c on a.LMG_mem_card_number=c.LMG_mem_card_number
left join spdtmp7.VB_AQ_LS_HC9_TXN d on a.LMG_mem_card_number=d.LMG_mem_card_number;
quit;



proc delete data=spdtmp7.VB_AQ_LS_HC3_TXN;
proc delete data=spdtmp7.VB_AQ_LS_HC6_TXN;
proc delete data=spdtmp7.VB_AQ_LS_HC9_TXN;
