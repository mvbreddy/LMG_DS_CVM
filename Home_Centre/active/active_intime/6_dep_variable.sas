...
where txn_dt_wid>=20170301 and txn_dt_wid<=20170331 and Lmg_concept_name="Home center";
run;
...
select a.*,b.* from spdtmp7.sd_hc_txn_final11 a left join spdtmp7.sd_hc_txn_dep2 b on
a.LMG_mem_card_number=b.LMG_mem_Card_number;
run;

data spdtmp7.sd_hc_txn_final2(compress=yes);
