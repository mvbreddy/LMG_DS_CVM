data spdtmp7.sd_hc_lifestage_apr ;
...
proc freq data=spdtmp7.sd_hc_lifestage_apr;
tables rfm_sgmnt_n Lstage_Sgmnt;

data spdtmp7.sd_hc_lifestage1_apr (keep= LMG_mem_Card_Number  RFM_1 RFM_2 RFM_3 RFM_4 RFM_5 RFM_6 Lstg_sgmnt_1 Lstg_sgmnt_2 Lstg_sgmnt_3 Lstg_sgmnt_4 Lstg_sgmnt_5 Lstg_sgmnt_6 Lstg_sgmnt_7);
set spdtmp7.sd_hc_lifestage_apr;
  ...
  proc sql; 
create table spdtmp7.sd_hc_txn_final6_apr as
select a.*,b.* from spdtmp7.sd_hc_txn_final5_apr a left join spdtmp7.sd_hc_lifestage1_apr b
on a.LMG_mem_card_number=b.LMG_mem_card_number;
quit;


proc freq data= spdtmp7.sd_hc_txn_final6_apr;
