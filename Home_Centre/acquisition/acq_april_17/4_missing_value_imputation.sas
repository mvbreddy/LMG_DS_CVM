...
data spdtmp7.sd_hc_txn_acapr_11 (compress= yes);
set spdtmp7.sd_hc_txn_acapr;
where age_group<> "NA";
run;
...
if age_group = "NA" and Rand_no <=0.0061 then age_group = "ag1";
else if age_group = "NA" and Rand_no > 0.0061 and Rand_no <= 0.0177 then age_group = "ag2";
else if age_group = "NA" and Rand_no > 0.0177 and Rand_no <= 0.1122 then age_group = "ag3";
else if age_group = "NA" and Rand_no > 0.1122 and Rand_no <= 0.5722then age_group = "ag4";
else if age_group = "NA" and Rand_no > 0.5722and Rand_no <= 0.9347 then age_group = "ag5";
else if age_group = "NA" and Rand_no > 0.9347 and Rand_no <= 0.9988 then age_group = "ag6";
...
set spdtmp7.sd_hc_txn_acapr;
Rand_no = ranuni(123);
if sex_mf_name = "NA" and Rand_no <=0.3949 then sex_mf_name = "F";
else if sex_mf_name = "NA" and Rand_no > 0.3949 and Rand_no <= 1 then sex_mf_name = "M";
else sex_mf_name=sex_mf_name;
run;
...
if cvm_nationality_group="NA" and Rand_no <=0.1600 then cvm_nationality_group = "Expat Arab";
else if cvm_nationality_group="NA" and Rand_no > 0.1600 and Rand_no <= .4466then cvm_nationality_group = "ISC";
else if cvm_nationality_group="NA" and Rand_no > 0.4466 and Rand_no <= .5565 then cvm_nationality_group = "Local";
else if cvm_nationality_group="NA" and Rand_no > 0.5565 and Rand_no <= 1 then cvm_nationality_group = "Others";
else cvm_nationality_group=cvm_nationality_group;
...
proc delete data=spdtmp7.sd_hc_txn_acapr_11;run;
