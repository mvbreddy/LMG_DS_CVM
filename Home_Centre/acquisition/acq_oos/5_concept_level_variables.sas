...
data spdtmp7.sd_hc_txn_acoosls(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
proc sql;
create table spdtmp7.sd_hc_txn_acoosls (compress=yes) as
...
from spdtmp7.sd_hc_txn_acoosls
...
data spdtmp7.sd_hc_txn_acoosls(compress=yes);
set spdtmp7.sd_hc_txn_acoosls;
...
data spdtmp7.sd_hc_txn_acooshb(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acoos_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_acooshb (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_acooshb
...
data spdtmp7.sd_hc_txn_acooshb(compress=yes);
set spdtmp7.sd_hc_txn_acooshb;
...
/*emax*/
data spdtmp7.sd_hc_txn_acoosem(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acoos_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_acoosem(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_acoosem
...
data spdtmp7.sd_hc_txn_acoosem(compress=yes);
set spdtmp7.sd_hc_txn_acoosem;
...
data spdtmp7.sd_hc_txn_acoosbs(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acoos_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_acoosbs (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_acoosbs
...
data spdtmp7.sd_hc_txn_acoosbs(compress=yes);
set spdtmp7.sd_hc_txn_acoosbs;
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_acoos a left join spdtmp7.sd_hc_txn_acoosls b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_acooshb c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_acoosem d on a.LMG_mem_card_number=d.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_acoosbs e
...
proc delete data=spdtmp7.sd_hc_txn_acoosls;run;
proc delete data= spdtmp7.sd_hc_txn_acooshb;run;
proc delete data=spdtmp7.sd_hc_txn_acoosem;run;
proc delete data=spdtmp7.sd_hc_txn_acoosbs;run;
