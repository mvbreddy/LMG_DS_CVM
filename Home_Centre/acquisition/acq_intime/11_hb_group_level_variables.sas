...
proc sql;
create table spdtmp7.sd_hc_txn_ac1 as
select a.*,b.grp_nm from spdtmp7.sd_hc_txn_ac1 a inner join saser.dim_itm_hb b on a.item_code=b.itm_cd;
run; 


proc freq data=spdtmp7.sd_hc_txn_ac1;
tables grp_nm;
run;
...
select a.*,b.* from spdtmp7.sd_hc_txn_ac a left join  spdtmp7.sd_hc_txn_ac2 b on a.LMG_mem_card_number=b.LMG_mem_card_number
;
quit; 