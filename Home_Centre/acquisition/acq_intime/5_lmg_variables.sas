...
data spdtmp7.sd_hc_txn_ac1(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
data spdtmp7.sd_hc_txn_ac2(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_ac_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_ac2(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_ac2(compress=yes);
set spdtmp7.sd_hc_txn_ac2;
...
data spdtmp7.sd_hc_txn_ac3(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_ac_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_ac3(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_ac3(compress=yes);
set spdtmp7.sd_hc_txn_ac3;
...
select a.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_ac a 
left join spdtmp7.sd_hc_txn_ac1 c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_ac2 d
on a.LMG_mem_card_number=d.LMG_mem_card_number left join spdtmp7.sd_hc_txn_ac3 e on a.LMG_mem_card_number=e.LMG_mem_card_number;
quit;
...
proc delete data=spdtmp7.sd_hc_txn_ac0;run;
proc delete data=spdtmp7.sd_hc_txn_ac1;run;
proc delete data=spdtmp7.sd_hc_txn_ac2;run;
proc delete data=spdtmp7.sd_hc_txn_ac3;run;
