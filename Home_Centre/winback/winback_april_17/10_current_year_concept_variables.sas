...
data spdtmp7.sd_hc_txn_wbaprlscy(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20160401 and txn_dt_wid<=20170331 and lmg_concept_name="Lifestyle"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprlscy (compress=yes) as
...
from spdtmp7.sd_hc_txn_wbaprlscy
...
data spdtmp7.sd_hc_txn_wbaprlscy(compress=yes);
set spdtmp7.sd_hc_txn_wbaprlscy;
format start_date_lscy ddmmyys10.;
format end_date_lscy ddmmyys10.;
recency_lscy=intck('day',end_date_lscy,'31Mar2017'd);
...
data spdtmp7.sd_hc_txn_wbaprhbcy(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20160401 and txn_dt_wid<=20170331 and lmg_concept_name="Home Box"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprhbcy (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbaprhbcy
...
data spdtmp7.sd_hc_txn_wbaprhbcy(compress=yes);
set spdtmp7.sd_hc_txn_wbaprhbcy;
format start_date_hbcy ddmmyys10.;
format end_date_hbcy ddmmyys10.;
recency_hbcy=intck('day',end_date_hbcy,'31Mar2017'd);
...
/*emax*/
data spdtmp7.sd_hc_txn_wbapremcy(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbapremcy(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbapremcy
...
data spdtmp7.sd_hc_txn_wbapremcy(compress=yes);
set spdtmp7.sd_hc_txn_wbapremcy;
format start_date_emcy ddmmyys10.;
format end_date_emcy ddmmyys10.;
recency_emcy=intck('day',end_date_emcy,'31Mar2017'd);
...
data spdtmp7.sd_hc_txn_wbaprbscy(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20160401 and txn_dt_wid<=20170331 and lmg_concept_name="Babyshop"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprbscy (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbaprbscy
...
data spdtmp7.sd_hc_txn_wbaprbscy(compress=yes);
set spdtmp7.sd_hc_txn_wbaprbscy;
format start_date_bscy ddmmyys10.;
format end_date_bscy ddmmyys10.;
recency_bscy=intck('day',end_date_bscy,'31Mar2017'd);
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_wbapr a left join spdtmp7.sd_hc_txn_wbaprlscy b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbaprhbcy c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbapremcy d on a.LMG_mem_card_number=d.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbaprbscy e
...
proc delete data=spdtmp7.sd_hc_txn_wbaprlscy;run;
proc delete data= spdtmp7.sd_hc_txn_wbaprhbcy;run;
proc delete data=spdtmp7.sd_hc_txn_wbapremcy;run;
proc delete data=spdtmp7.sd_hc_txn_wbaprbscy;run;
