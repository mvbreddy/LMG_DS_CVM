...
data spdtmp7.sd_hc_txn_wbaprsp(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20150401 and txn_dt_wid<=20160331 and lmg_concept_name="Splash"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprsp (compress=yes) as
...
from spdtmp7.sd_hc_txn_wbaprsp
...
data spdtmp7.sd_hc_txn_wbaprsp(compress=yes);
set spdtmp7.sd_hc_txn_wbaprsp;
format start_date_sp ddmmyys10.;
format end_date_sp ddmmyys10.;
recency_sp=intck('day',end_date_sp,'31Mar2016'd);
...
data spdtmp7.sd_hc_txn_wbaprmx(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20150401 and txn_dt_wid<=20160331 and lmg_concept_name="Max"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprmx (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbaprmx
...
data spdtmp7.sd_hc_txn_wbaprmx(compress=yes);
set spdtmp7.sd_hc_txn_wbaprmx;
...
data spdtmp7.sd_hc_txn_wbaprsm(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20150401 and txn_dt_wid<=20160331 and lmg_concept_name="Shoemart"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprsm (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbaprsm
...
data spdtmp7.sd_hc_txn_wbaprsm(compress=yes);
set spdtmp7.sd_hc_txn_wbaprsm;
...
select a.*,b.*,c.*,d.* from spdtmp7.sd_hc_txn_wbapr a left join spdtmp7.sd_hc_txn_wbaprsp b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbaprsm c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbaprmx d on a.LMG_mem_card_number=d.LMG_mem_card_number
;
quit;