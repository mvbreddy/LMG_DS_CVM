...
data spdtmp7.sd_hc_txn_wbls(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
proc sql;
create table spdtmp7.sd_hc_txn_wbls (compress=yes) as
...
data spdtmp7.sd_hc_txn_wbls(compress=yes);
set spdtmp7.sd_hc_txn_wbls;
...
data spdtmp7.sd_hc_txn_wbhb(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbhb (compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbhb(compress=yes);
set spdtmp7.sd_hc_txn_wbhb;
...
/*emax*/
data spdtmp7.sd_hc_txn_wbem(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbem(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbem(compress=yes);
set spdtmp7.sd_hc_txn_wbem;
...
data spdtmp7.sd_hc_txn_wbbs(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbbs (compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbbs(compress=yes);
set spdtmp7.sd_hc_txn_wbbs;
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_wb a left join spdtmp7.sd_hc_txn_wbls b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbhb c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbem d on a.LMG_mem_card_number=d.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbbs e
...
proc delete data=spdtmp7.sd_hc_txn_wbls;run;
proc delete data= spdtmp7.sd_hc_txn_wbhb;run;
proc delete data=spdtmp7.sd_hc_txn_wbem;run;
proc delete data=spdtmp7.sd_hc_txn_wbbs;run;
