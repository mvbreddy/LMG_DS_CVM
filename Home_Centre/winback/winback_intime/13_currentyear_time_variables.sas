...
data spdtmp7.sd_hc_txn_wbcy0(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb_all;
where txn_Dt_wid>=20160301 and txn_dt_wid<=20170228  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbcy0 (compress=yes) as
...
data spdtmp7.sd_hc_txn_wbcy0(compress=yes);
set spdtmp7.sd_hc_txn_wbcy0;
format start_date_lmgcy ddmmyys10.;
format end_date_lmgcy ddmmyys10.;
recency_lmgcy=intck('day',end_date_lmgcy,'28Feb2017'd);
...
data spdtmp7.sd_hc_txn_wbcy1(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb_all;
where txn_Dt_wid>=20161201 and txn_dt_wid<=20170228  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbcy1(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbcy1(compress=yes);
set spdtmp7.sd_hc_txn_wbcy1;
format start_date_lmgcy3 ddmmyys10.;
format end_date_lmgcy3 ddmmyys10.;
recency_lmgcy3=intck('day',end_date_lmgcy3,'28Feb2017'd);
...
data spdtmp7.sd_hc_txn_wbcy2(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb_all;
where txn_Dt_wid>=20160901 and txn_dt_wid<=20170228  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbcy2(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbcy2(compress=yes);
set spdtmp7.sd_hc_txn_wbcy2;
format start_date_lmgcy6 ddmmyys10.;
format end_date_lmgcy6 ddmmyys10.;
recency_lmgcy6=intck('day',end_date_lmgcy6,'28Feb2017'd);
...
data spdtmp7.sd_hc_txn_wbcy3(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb_all;
where txn_Dt_wid>=20160601 and txn_dt_wid<=20170228 and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbcy3(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbcy3(compress=yes);
set spdtmp7.sd_hc_txn_wbcy3;
format start_date_lmgcy9 ddmmyys10.;
format end_date_lmgcy9 ddmmyys10.;
recency_lmgcy9=intck('day',end_date_lmgcy9,'28Feb2017'd);
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_wb a left join spdtmp7.sd_hc_txn_wbcy0 b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbcy1 c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbcy2 d
on a.LMG_mem_card_number=d.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbcy3 e on a.LMG_mem_card_number=e.LMG_mem_card_number;
quit;
...
proc delete data=spdtmp7.sd_hc_txn_wbcy0;
proc delete data=spdtmp7.sd_hc_txn_wbcy1;
proc delete data=spdtmp7.sd_hc_txn_wbcy2;
proc delete data=spdtmp7.sd_hc_txn_wbcy3;
