...
data spdtmp7.sd_hc_txn_wboosls(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
proc sql;
create table spdtmp7.sd_hc_txn_wboosls (compress=yes) as
...
from spdtmp7.sd_hc_txn_wboosls
...
data spdtmp7.sd_hc_txn_wboosls(compress=yes);
set spdtmp7.sd_hc_txn_wboosls;
format start_date_ls ddmmyys10.;
format end_date_ls ddmmyys10.;
recency_ls=intck('day',end_date_ls,'28Feb2015'd);
...
data spdtmp7.sd_hc_txn_wbooshb(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wboos_all;
where txn_Dt_wid>=20140301 and txn_dt_wid<=20150228 and lmg_concept_name="Home Box"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbooshb (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbooshb
...
data spdtmp7.sd_hc_txn_wbooshb(compress=yes);
set spdtmp7.sd_hc_txn_wbooshb;
format start_date_hb ddmmyys10.;
format end_date_hb ddmmyys10.;
recency_hb=intck('day',end_date_hb,'28Feb2015'd);
...
/*emax*/
data spdtmp7.sd_hc_txn_wboosem(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wboos_all;
where txn_Dt_wid>=20140301 and txn_dt_wid<=20150228 and lmg_concept_name="Emax"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wboosem(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wboosem
...
data spdtmp7.sd_hc_txn_wboosem(compress=yes);
set spdtmp7.sd_hc_txn_wboosem;
format start_date_em ddmmyys10.;
format end_date_em ddmmyys10.;
recency_em=intck('day',end_date_em,'28Feb2015'd);
...
data spdtmp7.sd_hc_txn_wboosbs(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wboos_all;
where txn_Dt_wid>=20140301 and txn_dt_wid<=20150228 and lmg_concept_name="Babyshop"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wboosbs (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wboosbs
...
data spdtmp7.sd_hc_txn_wboosbs(compress=yes);
set spdtmp7.sd_hc_txn_wboosbs;
format start_date_bs ddmmyys10.;
format end_date_bs ddmmyys10.;
recency_bs=intck('day',end_date_bs,'28Feb2015'd);
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_wboos a left join spdtmp7.sd_hc_txn_wboosls b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbooshb c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wboosem d on a.LMG_mem_card_number=d.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wboosbs e
...
proc delete data=spdtmp7.sd_hc_txn_wboosls;run;
proc delete data= spdtmp7.sd_hc_txn_wbooshb;run;
proc delete data=spdtmp7.sd_hc_txn_wboosem;run;
proc delete data=spdtmp7.sd_hc_txn_wboosbs;run;
