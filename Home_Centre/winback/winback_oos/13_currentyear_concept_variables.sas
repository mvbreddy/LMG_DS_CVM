...
data spdtmp7.sd_hc_txn_wboos(compress=yes drop= perc_revenue_ls
perc_revenue_bs
perc_revenue_em 
perc_revenue_hb 
perc_unit_ls
...
data spdtmp7.sd_hc_txn_wbooslscy(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wboos_all;
where txn_Dt_wid>=20150301 and txn_dt_wid<=20160229 and lmg_concept_name="Lifestyle"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbooslscy (compress=yes) as
...
from spdtmp7.sd_hc_txn_wbooslscy
...
data spdtmp7.sd_hc_txn_wbooslscy(compress=yes);
set spdtmp7.sd_hc_txn_wbooslscy;
format start_date_lscy ddmmyys10.;
format end_date_lscy ddmmyys10.;
recency_lscy=intck('day',end_date_lscy,'29Feb2016'd);
...
data spdtmp7.sd_hc_txn_wbooshbcy(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wboos_all;
where txn_Dt_wid>=20150301 and txn_dt_wid<=20160229 and lmg_concept_name="Home Box"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbooshbcy (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbooshbcy
...
data spdtmp7.sd_hc_txn_wbooshbcy(compress=yes);
set spdtmp7.sd_hc_txn_wbooshbcy;
format start_date_hbcy ddmmyys10.;
format end_date_hbcy ddmmyys10.;
recency_hbcy=intck('day',end_date_hbcy,'29Feb2016'd);
...
/*emax*/
data spdtmp7.sd_hc_txn_wboosemcy(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wboos_all;
where txn_Dt_wid>=20150301 and txn_dt_wid<=20160229 and lmg_concept_name="Emax"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wboosemcy(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wboosemcy
...
data spdtmp7.sd_hc_txn_wboosemcy(compress=yes);
set spdtmp7.sd_hc_txn_wboosemcy;
format start_date_emcy ddmmyys10.;
format end_date_emcy ddmmyys10.;
recency_emcy=intck('day',end_date_emcy,'29Feb2016'd);
...
data spdtmp7.sd_hc_txn_wboosbscy(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wboos_all;
where txn_Dt_wid>=20150301 and txn_dt_wid<=20160229 and lmg_concept_name="Babyshop"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wboosbscy (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wboosbscy
...
data spdtmp7.sd_hc_txn_wboosbscy(compress=yes);
set spdtmp7.sd_hc_txn_wboosbscy;
format start_date_bscy ddmmyys10.;
format end_date_bscy ddmmyys10.;
recency_bscy=intck('day',end_date_bscy,'29Feb2016'd);
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_wboos a left join spdtmp7.sd_hc_txn_wbooslscy b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbooshbcy c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wboosemcy d on a.LMG_mem_card_number=d.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wboosbscy e
...
from spdtmp7.sd_hc_txn_wboos;
quit;

proc means data=spdtmp7.sd_hc_txn_wboos;
run;

proc delete data=spdtmp7.sd_hc_txn_wbooslscy;run;
proc delete data= spdtmp7.sd_hc_txn_wbooshbcy;run;
proc delete data=spdtmp7.sd_hc_txn_wboosemcy;run;
proc delete data=spdtmp7.sd_hc_txn_wboosbscy;run;
