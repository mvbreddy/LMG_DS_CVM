...
data spdtmp7.sd_hc_txn_ac_11 (compress= yes);
set spdtmp7.sd_hc_txn_ac;
where age_group<> "NA";
run;
...
else if age_group = "NA" and Rand_no > 0.0061 and Rand_no <= 0.0180 then age_group = "ag2";
else if age_group = "NA" and Rand_no > 0.0180 and Rand_no <= 0.1122 then age_group = "ag3";
else if age_group = "NA" and Rand_no > 0.1122 and Rand_no <= 0.5731then age_group = "ag4";
else if age_group = "NA" and Rand_no > 0.5731and Rand_no <= 0.9342 then age_group = "ag5";
else if age_group = "NA" and Rand_no > 0.9342 and Rand_no <= 0.9988 then age_group = "ag6";
...
set spdtmp7.sd_hc_txn_ac;
Rand_no = ranuni(123);
if sex_mf_name = "NA" and Rand_no <=0.3937 then sex_mf_name = "F";
else if sex_mf_name = "NA" and Rand_no > 0.3937 and Rand_no <= 1 then sex_mf_name = "M";
else sex_mf_name=sex_mf_name;
run;
...
if cvm_nationality_group="NA" and Rand_no <=0.1599 then cvm_nationality_group = "Expat Arab";
else if cvm_nationality_group="NA" and Rand_no > 0.1599 and Rand_no <= .4467then cvm_nationality_group = "ISC";
else if cvm_nationality_group="NA" and Rand_no > 0.4467 and Rand_no <= .5563 then cvm_nationality_group = "Local";
else if cvm_nationality_group="NA" and Rand_no > 0.5563 and Rand_no <= 1 then cvm_nationality_group = "Others";
else cvm_nationality_group=cvm_nationality_group;
...
proc delete data=spdtmp7.sd_hc_txn_ac_11;run;
