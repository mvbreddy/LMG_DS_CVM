...
data spdtmp7.sd_hc_txn_acmay1(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
proc sql;
create table spdtmp7.sd_hc_txn_acmay1(compress=yes) as
...
data spdtmp7.sd_hc_txn_acmay1(compress=yes);
set spdtmp7.sd_hc_txn_acmay1;
format start_date_lmg3 ddmmyys10.;
format end_date_lmg3 ddmmyys10.;
recency_lmg3=intck('day',end_date_lmg3,'30Apr2017'd);
...
data spdtmp7.sd_hc_txn_acmay2(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acmay_all;
...
data spdtmp7.sd_hc_txn_acmay2(compress=yes);
set spdtmp7.sd_hc_txn_acmay2;
format start_date_lmg6 ddmmyys10.;
format end_date_lmg6 ddmmyys10.;
recency_lmg6=intck('day',end_date_lmg6,'30Apr2017'd);
...
data spdtmp7.sd_hc_txn_acmay3(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acmay_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_acmay3(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_acmay3(compress=yes);
set spdtmp7.sd_hc_txn_acmay3;
format start_date_lmg9 ddmmyys10.;
format end_date_lmg9 ddmmyys10.;
recency_lmg9=intck('day',end_date_lmg9,'30Apr2017'd);
...
select a.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_acmay a 
left join spdtmp7.sd_hc_txn_acmay1 c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_acmay2 d
on a.LMG_mem_card_number=d.LMG_mem_card_number left join spdtmp7.sd_hc_txn_acmay3 e on a.LMG_mem_card_number=e.LMG_mem_card_number;
quit;
...
proc delete data=spdtmp7.sd_hc_txn_acmay0;run;
proc delete data=spdtmp7.sd_hc_txn_acmay1;run;
proc delete data=spdtmp7.sd_hc_txn_acmay2;run;
proc delete data=spdtmp7.sd_hc_txn_acmay3;run;
