...
/*data spdtmp7.sd_hc_txn_acmay(compress=yes drop= recency_ls recency_hb recency_bs recency_em);*/
...
data spdtmp7.sd_hc_txn_acmayls(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
proc sql;
create table spdtmp7.sd_hc_txn_acmayls (compress=yes) as
...
from spdtmp7.sd_hc_txn_acmayls
...
data spdtmp7.sd_hc_txn_acmayls(compress=yes);
set spdtmp7.sd_hc_txn_acmayls;
...
data spdtmp7.sd_hc_txn_acmayhb(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acmay_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_acmayhb (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_acmayhb
...
data spdtmp7.sd_hc_txn_acmayhb(compress=yes);
set spdtmp7.sd_hc_txn_acmayhb;
...
/*emax*/
data spdtmp7.sd_hc_txn_acmayem(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acmay_all;
where txn_Dt_wid>=20160501 and txn_dt_wid<=20170430 and lmg_concept_name="Emax"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_acmayem(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_acmayem
...
data spdtmp7.sd_hc_txn_acmayem(compress=yes);
set spdtmp7.sd_hc_txn_acmayem;
format start_date_em ddmmyys10.;
format end_date_em ddmmyys10.;
recency_em=intck('day',end_date_em,'30Apr2017'd);
...
data spdtmp7.sd_hc_txn_acmaybs(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acmay_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_acmaybs (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_acmaybs
...
data spdtmp7.sd_hc_txn_acmaybs(compress=yes);
set spdtmp7.sd_hc_txn_acmaybs;
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_acmay a left join spdtmp7.sd_hc_txn_acmayls b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_acmayhb c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_acmayem d on a.LMG_mem_card_number=d.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_acmaybs e
...
from spdtmp7.sd_hc_txn_acmay;
quit;

proc means data=spdtmp7.sd_hc_txn_acmay;
run;

proc delete data=spdtmp7.sd_hc_txn_acmayls;run;
proc delete data= spdtmp7.sd_hc_txn_acmayhb;run;
proc delete data=spdtmp7.sd_hc_txn_acmayem;run;
proc delete data=spdtmp7.sd_hc_txn_acmaybs;run;
