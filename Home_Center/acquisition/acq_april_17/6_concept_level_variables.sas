...
/*data spdtmp7.sd_hc_txn_acapr(compress=yes drop= recency_ls recency_hb recency_bs recency_em);*/
...
data spdtmp7.sd_hc_txn_acaprls(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
proc sql;
create table spdtmp7.sd_hc_txn_acaprls (compress=yes) as
...
from spdtmp7.sd_hc_txn_acaprls
...
data spdtmp7.sd_hc_txn_acaprls(compress=yes);
set spdtmp7.sd_hc_txn_acaprls;
...
data spdtmp7.sd_hc_txn_acaprhb(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acapr_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_acaprhb (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_acaprhb
...
data spdtmp7.sd_hc_txn_acaprhb(compress=yes);
set spdtmp7.sd_hc_txn_acaprhb;
...
/*emax*/
data spdtmp7.sd_hc_txn_acaprem(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acapr_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_acaprem(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_acaprem
...
data spdtmp7.sd_hc_txn_acaprem(compress=yes);
set spdtmp7.sd_hc_txn_acaprem;
...
data spdtmp7.sd_hc_txn_acaprbs(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_acapr_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_acaprbs (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_acaprbs
...
data spdtmp7.sd_hc_txn_acaprbs(compress=yes);
set spdtmp7.sd_hc_txn_acaprbs;
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_acapr a left join spdtmp7.sd_hc_txn_acaprls b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_acaprhb c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_acaprem d on a.LMG_mem_card_number=d.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_acaprbs e
...
proc delete data=spdtmp7.sd_hc_txn_acaprls;run;
proc delete data= spdtmp7.sd_hc_txn_acaprhb;run;
proc delete data=spdtmp7.sd_hc_txn_acaprem;run;
proc delete data=spdtmp7.sd_hc_txn_acaprbs;run;
