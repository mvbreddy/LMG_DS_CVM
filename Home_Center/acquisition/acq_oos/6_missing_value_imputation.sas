...
data spdtmp7.sd_hc_txn_acoos_11 (compress= yes);
set spdtmp7.sd_hc_txn_acoos;
where age_group<> "NA";
run;
...
if age_group = "NA" and Rand_no <=0.0066 then age_group = "ag1";
else if age_group = "NA" and Rand_no > 0.0066and Rand_no <= 0.0139 then age_group = "ag2";
else if age_group = "NA" and Rand_no > 0.0139 and Rand_no <= 0.0918 then age_group = "ag3";
else if age_group = "NA" and Rand_no > 0.0918 and Rand_no <= 0.5551then age_group = "ag4";
else if age_group = "NA" and Rand_no > 0.5551and Rand_no <= 0.9361 then age_group = "ag5";
else if age_group = "NA" and Rand_no > 0.9361 and Rand_no <= 0.9988 then age_group = "ag6";
...
set spdtmp7.sd_hc_txn_acoos;
Rand_no = ranuni(123);
if sex_mf_name = "NA" and Rand_no <=0.4190 then sex_mf_name = "F";
else if sex_mf_name = "NA" and Rand_no > 0.4190 and Rand_no <= 1 then sex_mf_name = "M";
else sex_mf_name=sex_mf_name;
run;
...
if cvm_nationality_group="NA" and Rand_no <=0.1893 then cvm_nationality_group = "Expat Arab";
else if cvm_nationality_group="NA" and Rand_no > 0.1893 and Rand_no <= .4977then cvm_nationality_group = "ISC";
else if cvm_nationality_group="NA" and Rand_no > 0.4977 and Rand_no <= .6267 then cvm_nationality_group = "Local";
else if cvm_nationality_group="NA" and Rand_no > 0.6267 and Rand_no <= 1 then cvm_nationality_group = "Others";
else cvm_nationality_group=cvm_nationality_group;
...
proc delete data=spdtmp7.sd_hc_txn_acoos_11;run;