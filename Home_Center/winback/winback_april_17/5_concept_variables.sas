...
data spdtmp7.sd_hc_txn_wbaprls(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20150401 and txn_dt_wid<=20160331 and lmg_concept_name="Lifestyle"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprls (compress=yes) as
...
from spdtmp7.sd_hc_txn_wbaprls
...
data spdtmp7.sd_hc_txn_wbaprls(compress=yes);
set spdtmp7.sd_hc_txn_wbaprls;
format start_date_ls ddmmyys10.;
format end_date_ls ddmmyys10.;
recency_ls=intck('day',end_date_ls,'31Mar2016'd);
...
data spdtmp7.sd_hc_txn_wbaprhb(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20150401 and txn_dt_wid<=20160331 and lmg_concept_name="Home Box"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprhb (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbaprhb
...
data spdtmp7.sd_hc_txn_wbaprhb(compress=yes);
set spdtmp7.sd_hc_txn_wbaprhb;
...
/*emax*/
data spdtmp7.sd_hc_txn_wbaprem(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20150401 and txn_dt_wid<=20160331 and lmg_concept_name="Emax"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprem(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbaprem
...
data spdtmp7.sd_hc_txn_wbaprem(compress=yes);
set spdtmp7.sd_hc_txn_wbaprem;
format start_date_em ddmmyys10.;
format end_date_em ddmmyys10.;
recency_em=intck('day',end_date_em,'31Mar2016'd);
...
data spdtmp7.sd_hc_txn_wbaprbs(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbapr_all;
where txn_Dt_wid>=20150401 and txn_dt_wid<=20160331 and lmg_concept_name="Babyshop"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbaprbs (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbaprbs
...
data spdtmp7.sd_hc_txn_wbaprbs(compress=yes);
set spdtmp7.sd_hc_txn_wbaprbs;
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_wbapr a left join spdtmp7.sd_hc_txn_wbaprls b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbaprhb c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbaprem d on a.LMG_mem_card_number=d.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbaprbs e
...
proc delete data=spdtmp7.sd_hc_txn_wbaprls;run;
proc delete data= spdtmp7.sd_hc_txn_wbaprhb;run;
proc delete data=spdtmp7.sd_hc_txn_wbaprem;run;
proc delete data=spdtmp7.sd_hc_txn_wbaprbs;run;
