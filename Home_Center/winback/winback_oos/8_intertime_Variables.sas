data spdtmp7.sd_hc_txn_wboos1(compress=yes keep= LMG_mem_card_number txn_dt_wid revenue_aed date);
set spdtmp7.sd_txn_wboos_all;
where txn_dt_wid>=20140301 and txn_dt_wid<=20150228 and Lmg_concept_name="Home center";
...
select a.*,b.* from spdtmp7.sd_hc_txn_wboos a left join spdtmp7.sd_hc_txn_wboos1 b
