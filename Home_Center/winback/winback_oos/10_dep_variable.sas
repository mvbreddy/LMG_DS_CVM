...
where txn_dt_wid>=20160101 and txn_dt_wid<=20160131 and LMG_concept_name="Home center" and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
select distinct LMG_mem_card_number from spdtmp7.sd_hc_txn_wboos1
...
select a.*,b.* from spdtmp7.sd_hc_txn_wboos a left join spdtmp7.sd_hc_txn_wboos1 b on
