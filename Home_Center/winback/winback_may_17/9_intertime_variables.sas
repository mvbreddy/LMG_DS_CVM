data spdtmp7.sd_hc_txn_wbmay1(compress=yes keep= LMG_mem_card_number txn_dt_wid revenue_aed date);
set spdtmp7.sd_txn_wbmay_all;
where txn_dt_wid>=20150501 and txn_dt_wid<=20160430 and Lmg_concept_name="Home center";
...
select a.*,b.* from spdtmp7.sd_hc_txn_wbmay a left join spdtmp7.sd_hc_txn_wbmay1 b
on a.LMG_mem_card_number=b.LMG_mem_card_number;
quit;
proc contents data= spdtmp7.sd_hc_txn_wbmay;
run;
