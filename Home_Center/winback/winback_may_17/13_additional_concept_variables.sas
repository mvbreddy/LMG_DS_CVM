...
data spdtmp7.sd_hc_txn_wbmaysp(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbmay_all;
where txn_Dt_wid>=20150501 and txn_dt_wid<=20160430 and lmg_concept_name="Splash"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbmaysp (compress=yes) as
...
from spdtmp7.sd_hc_txn_wbmaysp
...
data spdtmp7.sd_hc_txn_wbmaysp(compress=yes);
set spdtmp7.sd_hc_txn_wbmaysp;
format start_date_sp ddmmyys10.;
format end_date_sp ddmmyys10.;
recency_sp=intck('day',end_date_sp,'30Apr2016'd);
...
data spdtmp7.sd_hc_txn_wbmaymx(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbmay_all;
where txn_Dt_wid>=20150501 and txn_dt_wid<=20160430 and lmg_concept_name="Max"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbmaymx (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbmaymx
...
data spdtmp7.sd_hc_txn_wbmaymx(compress=yes);
set spdtmp7.sd_hc_txn_wbmaymx;
...
data spdtmp7.sd_hc_txn_wbmaysm(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbmay_all;
where txn_Dt_wid>=20150501 and txn_dt_wid<=20160430 and lmg_concept_name="Shoemart"  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbmaysm (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_wbmaysm
...
data spdtmp7.sd_hc_txn_wbmaysm(compress=yes);
set spdtmp7.sd_hc_txn_wbmaysm;
...
select a.*,b.*,c.*,d.* from spdtmp7.sd_hc_txn_wbmay a left join spdtmp7.sd_hc_txn_wbmaysp b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbmaysm c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbmaymx d on a.LMG_mem_card_number=d.LMG_mem_card_number
;
quit;