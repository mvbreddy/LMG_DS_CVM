...
proc sql;
select count(distinct LMG_mem_card_number) from spdtmp7.sd_hc_txn_wbmay1;
quit;
...
recency_3=intck('day',end_date_3,'30Apr2016'd);
...
data spdtmp7.sd_hc_txn_wbmay2(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbmay_all;
...
recency_6=intck('day',end_date_6,'30Apr2016'd);
...
data spdtmp7.sd_hc_txn_wbmay3(compress=yes keep=lmg_mem_card_number txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbmay_all;
...
recency_9=intck('day',end_date_9,'30Apr2016'd);
...
select a.*,b.*,c.*,d.* from spdtmp7.sd_hc_txn_wbmay a left join  spdtmp7.sd_hc_txn_wbmay1 b on a.Lmg_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbmay2 c on a.LMG_mem_card_number=c.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbmay3 d on a.LMG_mem_card_number=d.LMG_mem_card_number;
quit;
...
proc delete data=spdtmp7.sd_hc_txn_wbmay1;
proc delete data=spdtmp7.sd_hc_txn_wbmay2;
proc delete data=spdtmp7.sd_hc_txn_wbmay3;