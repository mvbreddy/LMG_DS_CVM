...
data spdtmp7.sd_hc_txn_wbmay0(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbmay_all;
where txn_Dt_wid>=20150501 and txn_dt_wid<=20160430  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbmay0 (compress=yes) as
...
data spdtmp7.sd_hc_txn_wbmay0(compress=yes);
set spdtmp7.sd_hc_txn_wbmay0;
format start_date_lmg ddmmyys10.;
format end_date_lmg ddmmyys10.;
recency_lmg=intck('day',end_date_lmg,'30Apr2016'd);
...
data spdtmp7.sd_hc_txn_wbmay1(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbmay_all;
where txn_Dt_wid>=20160201 and txn_dt_wid<=20160430 and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbmay1(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbmay1(compress=yes);
set spdtmp7.sd_hc_txn_wbmay1;
format start_date_lmg3 ddmmyys10.;
format end_date_lmg3 ddmmyys10.;
recency_lmg3=intck('day',end_date_lmg3,'30Apr2016'd);
...
data spdtmp7.sd_hc_txn_wbmay2(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbmay_all;
where txn_Dt_wid>=20151101 and txn_dt_wid<=20160430 and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
data spdtmp7.sd_hc_txn_wbmay2(compress=yes);
set spdtmp7.sd_hc_txn_wbmay2;
format start_date_lmg6 ddmmyys10.;
format end_date_lmg6 ddmmyys10.;
recency_lmg6=intck('day',end_date_lmg6,'30Apr2016'd);
...
data spdtmp7.sd_hc_txn_wbmay3(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wbmay_all;
where txn_Dt_wid>=20150801 and txn_dt_wid<=20160430  and revenue_aed>0 and units>0 and base_points_accrued >0 ;
date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
           format date ddmmyys10.;
run;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbmay3(compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbmay3(compress=yes);
set spdtmp7.sd_hc_txn_wbmay3;
format start_date_lmg9 ddmmyys10.;
format end_date_lmg9 ddmmyys10.;
recency_lmg9=intck('day',end_date_lmg9,'30Apr2016'd);
...
select a.*,b.*,c.*,d.*,e.* from spdtmp7.sd_hc_txn_wbmay a left join spdtmp7.sd_hc_txn_wbmay0 b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbmay1 c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbmay2 d
on a.LMG_mem_card_number=d.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbmay3 e on a.LMG_mem_card_number=e.LMG_mem_card_number;
quit;
...
proc delete data=spdtmp7.sd_hc_txn_wbmay0;run;
proc delete data=spdtmp7.sd_hc_txn_wbmay1;run;
proc delete data=spdtmp7.sd_hc_txn_wbmay2;run;
proc delete data=spdtmp7.sd_hc_txn_wbmay3;run;
