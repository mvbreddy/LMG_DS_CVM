...
select a.*,b.*,c.* from spdtmp7.sd_hc_txn_wb a left join  spdtmp7.sd_hc_txn_wb2 b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join  spdtmp7.sd_hc_txn_wb3 c on
