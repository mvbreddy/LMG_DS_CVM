...
data spdtmp7.sd_hc_txn_wbsp(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
proc sql;
create table spdtmp7.sd_hc_txn_wbsp (compress=yes) as
...
data spdtmp7.sd_hc_txn_wbsp(compress=yes);
set spdtmp7.sd_hc_txn_wbsp;
...
data spdtmp7.sd_hc_txn_wbmx(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbmx (compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbmx(compress=yes);
set spdtmp7.sd_hc_txn_wbmx;
...
data spdtmp7.sd_hc_txn_wbsm(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.sd_txn_wb_all;
...
proc sql;
create table spdtmp7.sd_hc_txn_wbsm (compress=yes) as
select distinct LMG_mem_card_number, 
...
data spdtmp7.sd_hc_txn_wbsm(compress=yes);
set spdtmp7.sd_hc_txn_wbsm;
...
select a.*,b.*,c.*,d.* from spdtmp7.sd_hc_txn_wb a left join spdtmp7.sd_hc_txn_wbsp b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_wbsm c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_wbmx d on a.LMG_mem_card_number=d.LMG_mem_card_number
;
quit;