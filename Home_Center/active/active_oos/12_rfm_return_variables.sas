...
select a.*,b.* from spdtmp7.sd_hc_txn_final6_oos a left join spdtmp7.sd_hc_lifestage_return b
...
proc sql; 
create table spdtmp7.sd_hc_txn_final6_oos(compress=y) as
select a.*,b.* from spdtmp7.sd_hc_txn_final6_oos a left join spdtmp7.sd_hc_lifestage_add b
on a.LMG_mem_card_number=b.LMG_mem_card_number;
quit;