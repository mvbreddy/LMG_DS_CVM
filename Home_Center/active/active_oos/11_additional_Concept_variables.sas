...
data spdtmp7.sd_hc_txn_final6_oossp(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
proc sql;
create table spdtmp7.sd_hc_txn_final6_oossp (compress=yes) as
...
from spdtmp7.sd_hc_txn_final6_oossp
...
data spdtmp7.sd_hc_txn_final6_oossp(compress=yes);
set spdtmp7.sd_hc_txn_final6_oossp;
...
data spdtmp7.sd_hc_txn_final6_oosmx(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set sascrm.tn_itm_rev_ae;
...
proc sql;
create table spdtmp7.sd_hc_txn_final6_oosmx (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_final6_oosmx
...
data spdtmp7.sd_hc_txn_final6_oosmx(compress=yes);
set spdtmp7.sd_hc_txn_final6_oosmx;
...
data spdtmp7.sd_hc_txn_final6_oossm(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set sascrm.tn_itm_rev_ae;
...
proc sql;
create table spdtmp7.sd_hc_txn_final6_oossm (compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.sd_hc_txn_final6_oossm
...
data spdtmp7.sd_hc_txn_final6_oossm(compress=yes);
set spdtmp7.sd_hc_txn_final6_oossm;
...
select a.*,b.*,c.*,d.* from spdtmp7.sd_hc_txn_final6_oos a left join spdtmp7.sd_hc_txn_final6_oossp b on a.LMG_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.sd_hc_txn_final6_oossm c on a.LMG_mem_card_number=c.LMG_mem_card_number left join spdtmp7.sd_hc_txn_final6_oosmx d on a.LMG_mem_card_number=d.LMG_mem_card_number
;
quit;