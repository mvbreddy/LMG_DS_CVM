...
data spdtmp7.sd_hc_txn_grp2_oos;
set spdtmp7.sd_hc_txn_grp1_oos;
where hc_group="Furniture" or hc_group="kids" or hc_group="Household";
run;


proc sql;
create table spdtmp7.sd_hc_txn_grp3_oos as
...
from spdtmp7.sd_hc_txn_grp2_oos group by LMG_mem_card_number;
quit;

data spdtmp7.sd_hc_txn_grp4_oos;
set spdtmp7.sd_hc_txn_grp3;
run;

proc sql;
create table spdtmp7.sd_hc_txn_final3_oos(compress=yes) as
select a.*,b.* from spdtmp7.sd_hc_txn_final1_oos a left join  spdtmp7.sd_hc_txn_grp3_oos b on
...
proc sql;
create table spdtmp7.sd_hc_txn_grp4_oos(compress=yes) as 
select LMG_mem_card_number,
...
proc sql;
create table spdtmp7.sd_hc_txn_final3_oos(compress=yes) as
select a.*,b.* from spdtmp7.sd_hc_txn_final3_oos a left join  spdtmp7.sd_hc_txn_grp4_oos b on
a.LMG_mem_card_number=b.LMG_mem_card_number  ;
quit; 


proc means data=spdtmp7.sd_hc_txn_final3_oos;
run;