...
data spdtmp7.sd_hc_txn_grp2_may;
set spdtmp7.sd_hc_txn_grp1_may;
where hc_group="Furniture" or hc_group="kids" or hc_group="Household";
run;


proc sql;
create table spdtmp7.sd_hc_txn_grp3_may as
...
from spdtmp7.sd_hc_txn_grp2_may group by LMG_mem_card_number;
quit;
...
select a.*,b.* from spdtmp7.sd_hc_activemay a left join  spdtmp7.sd_hc_txn_grp3_may b on
a.LMG_mem_card_number=b.LMG_mem_card_number  ;
quit; 


proc sql;
create table spdtmp7.sd_hc_txn_grp4_may(compress=yes) as 
select LMG_mem_card_number,
...
proc sql;
create table spdtmp7.sd_hc_activemay(compress=yes) as
select a.*,b.* from spdtmp7.sd_hc_activemay a left join  spdtmp7.sd_hc_txn_grp4_may b on
a.LMG_mem_card_number=b.LMG_mem_card_number  ;
quit; 
